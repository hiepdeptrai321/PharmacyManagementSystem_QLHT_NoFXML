...
public class ThietLapDonViTinh_Them_GUI {

    public void showWithController(Stage stage, ThietLapDonViTinh_Them_Ctrl ctrl) {
        ...
        // Assemble
        root.getChildren().addAll(lbTitle, leftVBox, rightVBox, img, btnThem, btnHuy);
